 ...
 *           &lt;element ref="{urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0}text-content"/&gt;
 *           &lt;group ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}number-text-with-fillchar" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "text-style")
public class TextStyle {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "text-content", namespace = "urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0", type = TextContent.class, required = false),
