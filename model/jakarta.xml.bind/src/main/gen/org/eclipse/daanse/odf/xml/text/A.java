 ...
 *         &lt;group ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}paragraph-content" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}text-a-attlist"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class A {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "event-listeners", namespace = "urn:oasis:names:tc:opendocument:xmlns:office:1.0", type = EventListeners.class, required = false),
    ...
    @XmlAttribute(name = "visited-style-name", namespace = "urn:oasis:names:tc:opendocument:xmlns:text:1.0")
    protected String visitedStyleName;
    ...
    /**
     * Gets the value of the visitedStyleName property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the visitedStyleName property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setVisitedStyleName(String value) {
        this.visitedStyleName = value;
    }
