 ...
 *       &lt;/sequence&gt;
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}style-background-image-attlist"/&gt;
...
@XmlRootElement(name = "background-image")
public class BackgroundImage {
    ...
    @XmlAttribute(name = "filter-name", namespace = "urn:oasis:names:tc:opendocument:xmlns:style:1.0")
