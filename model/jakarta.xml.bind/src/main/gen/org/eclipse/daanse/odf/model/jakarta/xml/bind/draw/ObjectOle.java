 ...
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}draw-object-ole-attlist"/&gt;
...
@XmlRootElement(name = "object-ole")
public class ObjectOle {
    ...
    @XmlAttribute(name = "class-id", namespace = "urn:oasis:names:tc:opendocument:xmlns:drawing:1.0")
