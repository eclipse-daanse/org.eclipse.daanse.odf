 ...
 *           &lt;group ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}any-time"/&gt;
 *           &lt;group ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}number-text-with-fillchar" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
 *         &lt;element ref="{urn:oasis:names:tc:opendocument:xmlns:style:1.0}map" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}number-time-style-attlist"/&gt;
...
@XmlRootElement(name = "time-style")
public class TimeStyle {
    ...
    @XmlAttribute(name = "truncate-on-overflow", namespace = "urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0")
    protected Boolean truncateOnOverflow;
    ...
    /**
     * Gets the value of the truncateOnOverflow property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Sets the value of the truncateOnOverflow property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setTruncateOnOverflow(Boolean value) {
        this.truncateOnOverflow = value;
    }
