 ...
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}anim-transition-filter-attlist"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class TransitionFilter {
    ...
    @XmlAttribute(name = "type", namespace = "urn:oasis:names:tc:opendocument:xmlns:smil-compatible:1.0", required = true)
    ...
    @XmlAttribute(name = "mode", namespace = "urn:oasis:names:tc:opendocument:xmlns:smil-compatible:1.0")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
