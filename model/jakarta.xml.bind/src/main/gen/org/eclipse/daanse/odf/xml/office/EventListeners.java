...
public class EventListeners {
    ...
    @XmlElements({
        @XmlElement(name = "event-listener", namespace = "urn:oasis:names:tc:opendocument:xmlns:script:1.0", type = org.eclipse.daanse.odf.xml.script.EventListener.class),
        @XmlElement(name = "event-listener", namespace = "urn:oasis:names:tc:opendocument:xmlns:presentation:1.0", type = org.eclipse.daanse.odf.xml.presentation.EventListener.class)
    })
     ...
     * {@link org.eclipse.daanse.odf.xml.script.EventListener }
     * {@link org.eclipse.daanse.odf.xml.presentation.EventListener }
     * 
     * 
     */
