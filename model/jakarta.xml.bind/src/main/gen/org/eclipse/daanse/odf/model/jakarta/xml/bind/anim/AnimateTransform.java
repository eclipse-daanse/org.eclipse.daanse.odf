 ...
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}anim-animate-transform-attlist"/&gt;
...
public class AnimateTransform {
    ...
    @XmlAttribute(name = "type", namespace = "urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
