 ...
 *       &lt;attribute name="duration" type="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}duration" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlRootElement(name = "editing-duration")
public class EditingDuration {

    @XmlValue
    protected String content;
    @XmlAttribute(name = "duration", namespace = "urn:oasis:names:tc:opendocument:xmlns:text:1.0")
