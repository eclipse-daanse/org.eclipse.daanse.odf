...
/**
 * <p>Java class for text-database-row-select-attlist complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="text-database-row-select-attlist"&gt;
 *   &lt;complexContent&gt;
 ...
 *       &lt;attribute name="row-number" type="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}nonNegativeInteger" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "text-database-row-select-attlist", propOrder = {
    "connectionResource"
})
public class TextDatabaseRowSelectAttlist {
    ...
    @XmlAttribute(name = "row-number", namespace = "urn:oasis:names:tc:opendocument:xmlns:text:1.0")
