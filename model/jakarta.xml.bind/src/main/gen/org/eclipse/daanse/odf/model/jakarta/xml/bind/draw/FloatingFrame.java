 ...
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}common-draw-data-attlist"/&gt;
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}draw-floating-frame-attlist"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "")
@XmlRootElement(name = "floating-frame")
public class FloatingFrame {
    ...
    @XmlAttribute(name = "frame-name", namespace = "urn:oasis:names:tc:opendocument:xmlns:drawing:1.0")
