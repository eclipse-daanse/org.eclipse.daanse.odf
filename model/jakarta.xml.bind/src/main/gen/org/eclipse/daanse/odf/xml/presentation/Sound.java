 ...
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}presentation-sound-attlist"/&gt;
...
public class Sound {
    ...
    @XmlAttribute(name = "play-full", namespace = "urn:oasis:names:tc:opendocument:xmlns:presentation:1.0")
    protected Boolean playFull;
    ...
    /**
     * Gets the value of the playFull property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Sets the value of the playFull property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setPlayFull(Boolean value) {
        this.playFull = value;
    }
