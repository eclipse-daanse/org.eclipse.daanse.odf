 ...
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}table-database-source-table-attlist"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "")
@XmlRootElement(name = "database-source-table")
public class DatabaseSourceTable {

    @XmlAttribute(name = "database-name", namespace = "urn:oasis:names:tc:opendocument:xmlns:table:1.0", required = true)
    protected String databaseName;
    @XmlAttribute(name = "database-table-name", namespace = "urn:oasis:names:tc:opendocument:xmlns:table:1.0", required = true)
