 ...
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}form-radio-attlist"/&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
    ...
    extends CommonFormControlContent
{
    ...
    @XmlAttribute(name = "current-selected", namespace = "urn:oasis:names:tc:opendocument:xmlns:form:1.0")
    protected Boolean currentSelected;
    @XmlAttribute(name = "title", namespace = "urn:oasis:names:tc:opendocument:xmlns:form:1.0")
    protected String title;
    @XmlAttribute(name = "selected", namespace = "urn:oasis:names:tc:opendocument:xmlns:form:1.0")
