 ...
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}anim-animate-motion-attlist"/&gt;
...
public class AnimateMotion {
    ...
    @XmlAttribute(name = "path", namespace = "urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0")
    protected String path;
    @XmlAttribute(name = "origin", namespace = "urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0")
