 ...
 *         &lt;element ref="{urn:oasis:names:tc:opendocument:xmlns:drawing:1.0}enhanced-geometry" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 ...
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}draw-custom-shape-attlist"/&gt;
...
@XmlRootElement(name = "custom-shape")
public class CustomShape {
    ...
    @XmlElement(name = "enhanced-geometry")
    protected EnhancedGeometry enhancedGeometry;
    ...
    @XmlAttribute(name = "engine", namespace = "urn:oasis:names:tc:opendocument:xmlns:drawing:1.0")
    protected QName engine;
    @XmlAttribute(name = "data", namespace = "urn:oasis:names:tc:opendocument:xmlns:drawing:1.0")
    ...
    /**
     * Gets the value of the enhancedGeometry property.
     * 
     * @return
     *     possible object is
     *     {@link EnhancedGeometry }
     *     
     */
    ...
    /**
     * Sets the value of the enhancedGeometry property.
     * 
     * @param value
     *     allowed object is
     *     {@link EnhancedGeometry }
     *     
     */
    public void setEnhancedGeometry(EnhancedGeometry value) {
        this.enhancedGeometry = value;
    }
     ...
     *     
     */
    public void setEngine(QName value) {
        this.engine = value;
    }
