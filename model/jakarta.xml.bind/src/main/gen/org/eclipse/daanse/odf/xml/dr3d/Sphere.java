 ...
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}dr3d-sphere-attlist"/&gt;
...
public class Sphere {
    ...
    @XmlAttribute(name = "center", namespace = "urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0")
    protected String center;
    @XmlAttribute(name = "size", namespace = "urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0")
