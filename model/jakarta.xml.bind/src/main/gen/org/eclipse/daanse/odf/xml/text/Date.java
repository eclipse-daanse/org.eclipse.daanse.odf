 ...
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}text-date-attlist"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class Date {
    ...
    @XmlAttribute(name = "date-adjust", namespace = "urn:oasis:names:tc:opendocument:xmlns:text:1.0")
    protected Duration dateAdjust;
    ...
    /**
     * Gets the value of the dateAdjust property.
     * 
     * @return
     *     possible object is
     *     {@link Duration }
    ...
    /**
     * Sets the value of the dateAdjust property.
     * 
     * @param value
     *     allowed object is
     *     {@link Duration }
     *     
     */
    public void setDateAdjust(Duration value) {
        this.dateAdjust = value;
    }
