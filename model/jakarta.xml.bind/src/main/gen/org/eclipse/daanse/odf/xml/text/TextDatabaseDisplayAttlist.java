...
/**
 * <p>Java class for text-database-display-attlist complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="text-database-display-attlist"&gt;
 *   &lt;complexContent&gt;
 ...
 *       &lt;attribute name="column-name" use="required" type="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}string" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "text-database-display-attlist", propOrder = {
    "content"
})
public class TextDatabaseDisplayAttlist {
    ...
    @XmlAttribute(name = "column-name", namespace = "urn:oasis:names:tc:opendocument:xmlns:text:1.0", required = true)
