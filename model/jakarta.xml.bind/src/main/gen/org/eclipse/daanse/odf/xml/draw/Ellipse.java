 ...
 *       &lt;/sequence&gt;
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0}ry"/&gt;
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0}rx"/&gt;
 ...
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}common-draw-circle-ellipse-attlist"/&gt;
 ...
 *       &lt;attribute ref="{urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0}cx"/&gt;
 *       &lt;attribute ref="{urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0}cy"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class Ellipse {
    ...
    protected String cy;
    @XmlAttribute(name = "ry", namespace = "urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0", required = true)
    protected String ry;
    @XmlAttribute(name = "rx", namespace = "urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0", required = true)
    protected String rx;
    ...
    @XmlAttribute(name = "kind", namespace = "urn:oasis:names:tc:opendocument:xmlns:drawing:1.0")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String kind;
    @XmlAttribute(name = "start-angle", namespace = "urn:oasis:names:tc:opendocument:xmlns:drawing:1.0")
    protected String startAngle;
    @XmlAttribute(name = "end-angle", namespace = "urn:oasis:names:tc:opendocument:xmlns:drawing:1.0")
