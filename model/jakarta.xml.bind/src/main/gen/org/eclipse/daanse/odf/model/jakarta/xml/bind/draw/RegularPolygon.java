 ...
 *       &lt;/sequence&gt;
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}draw-regular-polygon-attlist"/&gt;
...
@XmlRootElement(name = "regular-polygon")
public class RegularPolygon {
    ...
    @XmlAttribute(name = "concave", namespace = "urn:oasis:names:tc:opendocument:xmlns:drawing:1.0", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String concave;
    @XmlAttribute(name = "sharpness", namespace = "urn:oasis:names:tc:opendocument:xmlns:drawing:1.0")
    protected String sharpness;
    @XmlAttribute(name = "corners", namespace = "urn:oasis:names:tc:opendocument:xmlns:drawing:1.0", required = true)
    protected BigInteger corners;
    ...
    /**
     * Gets the value of the concave property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the concave property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setConcave(String value) {
        this.concave = value;
    }
     ...
     *     
     */
    public void setCorners(BigInteger value) {
        this.corners = value;
    }
