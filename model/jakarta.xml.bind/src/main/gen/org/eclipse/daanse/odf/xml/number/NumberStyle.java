 ...
 *           &lt;element ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}any-number"/&gt;
 *           &lt;group ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}number-text-with-fillchar" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "number-style")
public class NumberStyle {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "any-number", namespace = "urn:oasis:names:tc:opendocument:xmlns:text:1.0", type = JAXBElement.class, required = false),
     ...
     * {@link JAXBElement }{@code <}{@link Fraction }{@code >}
     * {@link JAXBElement }{@code <}{@link ScientificNumber }{@code >}
