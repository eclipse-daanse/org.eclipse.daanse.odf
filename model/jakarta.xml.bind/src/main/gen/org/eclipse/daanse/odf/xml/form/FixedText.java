 ...
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}form-fixed-text-attlist"/&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
    ...
    extends CommonFormControlContent
{
    ...
    @XmlAttribute(name = "multi-line", namespace = "urn:oasis:names:tc:opendocument:xmlns:form:1.0")
