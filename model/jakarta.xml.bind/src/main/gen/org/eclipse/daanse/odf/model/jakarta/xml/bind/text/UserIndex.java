 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}user-index-source"/&gt;
...
@XmlRootElement(name = "user-index")
public class UserIndex {

    @XmlElement(name = "user-index-source", required = true)
    protected UserIndexSource userIndexSource;
    ...
    /**
     * Gets the value of the userIndexSource property.
     * 
     * @return
     *     possible object is
     *     {@link UserIndexSource }
     *     
     */
    public UserIndexSource getUserIndexSource() {
        return userIndexSource;
    }

    /**
     * Sets the value of the userIndexSource property.
     * 
     * @param value
     *     allowed object is
     *     {@link UserIndexSource }
     *     
     */
    public void setUserIndexSource(UserIndexSource value) {
        this.userIndexSource = value;
    }
