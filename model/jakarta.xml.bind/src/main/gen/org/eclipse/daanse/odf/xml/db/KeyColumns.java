 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:oasis:names:tc:opendocument:xmlns:database:1.0}key-column" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "key-columns")
public class KeyColumns {

    @XmlElement(name = "key-column", required = true)
    protected List<KeyColumn> keyColumn;
     ...
     * 
     */
    public List<KeyColumn> getKeyColumn() {
        if (keyColumn == null) {
            keyColumn = new ArrayList<KeyColumn>();
        }
