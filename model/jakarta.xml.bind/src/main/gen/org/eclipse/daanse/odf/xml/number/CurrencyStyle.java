 ...
 *         &lt;choice minOccurs="0"&gt;
 *           &lt;sequence&gt;
 *             &lt;group ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}number-and-text"/&gt;
 *             &lt;group ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}currency-symbol-and-text" minOccurs="0"/&gt;
 *           &lt;/sequence&gt;
 *           &lt;sequence&gt;
 *             &lt;group ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}currency-symbol-and-text"/&gt;
 *             &lt;group ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}number-and-text" minOccurs="0"/&gt;
 *           &lt;/sequence&gt;
 *         &lt;/choice&gt;
...
@XmlRootElement(name = "currency-style")
public class CurrencyStyle {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "number", namespace = "urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "currency-symbol", namespace = "urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0", type = CurrencySymbol.class, required = false),
