 ...
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}draw-hatch-attlist"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "")
@XmlRootElement(name = "hatch")
public class Hatch {

    @XmlAttribute(name = "display-name", namespace = "urn:oasis:names:tc:opendocument:xmlns:drawing:1.0")
    protected String displayName;
    @XmlAttribute(name = "color", namespace = "urn:oasis:names:tc:opendocument:xmlns:drawing:1.0")
    protected String color;
    @XmlAttribute(name = "rotation", namespace = "urn:oasis:names:tc:opendocument:xmlns:drawing:1.0")
