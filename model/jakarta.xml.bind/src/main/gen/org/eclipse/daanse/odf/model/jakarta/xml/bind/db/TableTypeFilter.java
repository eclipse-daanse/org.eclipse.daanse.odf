 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:oasis:names:tc:opendocument:xmlns:database:1.0}table-type" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "table-type-filter")
public class TableTypeFilter {
    ...
    public List<String> getTableType() {
        if (tableType == null) {
            tableType = new ArrayList<String>();
        }
