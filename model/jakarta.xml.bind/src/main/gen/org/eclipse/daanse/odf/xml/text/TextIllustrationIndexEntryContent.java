...
/**
 * <p>Java class for text-illustration-index-entry-content complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="text-illustration-index-entry-content"&gt;
 *   &lt;complexContent&gt;
 ...
 *       &lt;/choice&gt;
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}text-illustration-index-entry-template-attrs"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "text-illustration-index-entry-content", propOrder = {
    "indexEntryChapterOrIndexEntryPageNumberOrIndexEntryText"
})
public class TextIllustrationIndexEntryContent {
