...
package org.eclipse.daanse.odf.model.jakarta.xml.bind.script;
 ...
 *       &lt;attGroup ref="{urn:oasis:names:tc:opendocument:xmlns:text:1.0}script-event-listener-attlist"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class EventListener {
    ...
    @XmlAttribute(name = "language", namespace = "urn:oasis:names:tc:opendocument:xmlns:script:1.0", required = true)
    protected String language;
    @XmlAttribute(name = "macro-name", namespace = "urn:oasis:names:tc:opendocument:xmlns:script:1.0")
